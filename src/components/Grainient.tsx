...
void mainImage(out vec4 o, vec2 C) {
  ...
  float amplitude = max(uWarpAmplitude, 0.001);
  float warpTime = t * uWarpSpeed;
  tuv.x += sin(tuv.y * frequency + warpTime) * warpStrength / amplitude;
  tuv.y += sin(tuv.x * (frequency * 1.5) + warpTime) * warpStrength / (amplitude * 0.5);
